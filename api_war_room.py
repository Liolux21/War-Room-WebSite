...
def extraire_donnees_api(team_id, team_name):
    ...
    # On supprime l'appel bloquant "xgfixture"
    url_team = f"https://api.sportmonks.com/v3/football/teams/{team_id}?include=latest.statistics;upcoming"
    ...
    try:
        ...
        for match in derniers_matchs[:5]:
            ...
            if "statistics" in match and isinstance(match["statistics"], list):
                for stat in match["statistics"]:
                    ...
                    # 84 = Corners | 86 = Tirs Cadrés | 45 = Possession
                    if type_id == 84:
                        stats["Corners"] += val
        ...
        synthese = {
            ...
            "Moy_xG_5M": "Premium Requis", # On marque explicitement l'absence de xG
